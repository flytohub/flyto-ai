...
Inventory: **87 declared symbols** and **8 class methods**.
...
Source: [`flyto_ai/tools/core_tools.py:1110`](../../../flyto_ai/tools/core_tools.py#L1110)
...
## `flyto_ai.tools.parameter_references`

### `UnresolvedParameterReference` (public)

`class UnresolvedParameterReference(ValueError)`

Source: [`flyto_ai/tools/parameter_references.py:9`](../../../flyto_ai/tools/parameter_references.py#L9)

A module must not receive a workflow placeholder as a literal value.

### `_references` (internal)

`_references(value, depth = 0)`
Source: [`flyto_ai/tools/parameter_references.py:13`](../../../flyto_ai/tools/parameter_references.py#L13)

Internal `_references` implementation on this module; the linked source is authoritative.

### `_json_context` (internal)

`_json_context(value, depth = 0)`
Source: [`flyto_ai/tools/parameter_references.py:26`](../../../flyto_ai/tools/parameter_references.py#L26)

Internal `_json_context` implementation on this module; the linked source is authoritative.

### `_normalize` (internal)

`_normalize(value)`
Source: [`flyto_ai/tools/parameter_references.py:41`](../../../flyto_ai/tools/parameter_references.py#L41)

Internal `_normalize` implementation on this module; the linked source is authoritative.

### `resolve_module_params` (public)

`resolve_module_params(params, context)`
Source: [`flyto_ai/tools/parameter_references.py:52`](../../../flyto_ai/tools/parameter_references.py#L52)
